...
`<blink>New!</blink>` switched its text on and off about once a second, for as long as the page
...
the element in Firefox 23, in 2013. The markup is dead: its text simply shows, like any unknown
inline element.
...
If something genuinely needs attention, make it static and meaningful: `<strong>` for
