...
A `<meta http-equiv="default-style">` sets the name of the default CSS style
...
page — unstyled content first, then the preferred set — the mechanism fighting
...
verdict, so the selector matches the value case-insensitively and nothing else
is needed.
